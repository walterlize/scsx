...
class Countcomp extends CI_Controller {
    ...
    public function college() {
        $this->timeOut();
        //1.学院名
        $college = urldecode($this->uri->segment(4));
        //2.查找该学院课程的基地
        ...
        $this->load->view('superadmin/count/colCourCompany',$data);
    ...
    public function courcomp(){
        ...
        $config['base_url'] = base_url() . 'index.php/superadmin/countcomp/courcomp/'.$cour_id;
        ...
        $data['cour']=$coursep;
        $this->load->view('common/header3');
        $this->load->view('superadmin/count/courcomp',$data);
        $this->load->view('common/footer');
    }
