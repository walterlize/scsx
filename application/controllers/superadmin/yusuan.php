...
class Yusuan extends CI_Controller {
    ...
    public function yusuanList() {
        ...
        $array = array('ys_term'=>$term,'ys_state >=' =>2,'ys_state !='=>3);
        $this->load->model('m_yusuan');
        $num = $this->m_yusuan->getNum($array);
        $offset = $this->uri->segment(4);

        $data['yusuan'] = $this->getYusuans($array,$offset);
        $config['base_url'] = base_url() . 'index.php/superadmin/yusuan/yusuanList';
        ...
        $this->load->view('superadmin/yusuan/yusuan', $data);
    ...
    public function yusuanDetail() {
       $ys_id = $this->uri->segment(4);
    	...
    	$this->load->view('common/header3');
    	$this->load->view('superadmin/yusuan/yusuanDetail', $data);
    	$this->load->view('common/footer');
    }
    ...
    public function yusuanEdit() {
    	...
    	$this->load->view('common/header3');
    	$this->load->view('superadmin/yusuan/yusuanEdit', $data);
    	$this->load->view('common/footer');
    }    
    ...
    public function update(){
    	...
    	$arrYusuan = array(
    			'ys_state2'=>$ys_state,
    			'ys_state'=>$ys_state,
    			'ys_idea'=>$ys_coll_idea,
    			'ys_audit_num2'=>$ys_audit_num,
    			'ys_audit_name2'=>$ys_audit_name
    			
    	);
    	$this->m_yusuan->updateYusuan($ys_id,$arrYusuan);
    	
    	redirect("superadmin/yusuan/yusuanDetail/".$ys_id);
