...
class News extends CI_Controller {
	...
	public function noticeList(){
		...
		$config['base_url'] = base_url() . 'index.php/superadmin/news/noticeList';
		$config['total_rows'] = $num;
		$config['uri_segment'] = 4;
		$this->pagination->initialize($config);
		$data['page'] = $this->pagination->create_links();
	...
	public function ruleList(){
		...
		$config['base_url'] = base_url() . 'index.php/superadmin/news/ruleList';
		$config['total_rows'] = $num;
		$config['uri_segment'] = 4;
		$this->pagination->initialize($config);
		$data['page'] = $this->pagination->create_links();
	...
	public function sumList(){
		...
		$config['base_url'] = base_url() . 'index.php/superadmin/news/sumList';
		$config['total_rows'] = $num;
		$config['uri_segment'] = 4;
		$this->pagination->initialize($config);
		$data['page'] = $this->pagination->create_links();
