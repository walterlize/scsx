...
class m_mscore extends CI_Model {
    ...
    function updateYstateId($ystateId, $b_id) {
        $this->b_id = $b_id;
        $this->ystateId = $ystateId;
        $id = $this->b_id;
        $data = array(
            'ystateId' => $ystateId
        );
    ...
    function getMscores2($array, $per_page, $offset) {
        $this->db->select();
    ...
    function sgetMscores($array, $per_page, $offset) {
        ...
        $q = $this->db->get('ws_mscore1', $per_page, $offset);
        return $q->result();
    }
