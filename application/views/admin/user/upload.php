...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    ...
    <body> 
        ...
        <table width="98%" border="0" align="center" style="margin-top:20px; border:1px solid #9abcde;"> 
            <form id="form1" name="form1" enctype="multipart/form-data" method="post" action="<?=  base_url()?>index.php/admin/user/shangchuan"> 

                <tr > 
                    <td height="28" colspan="2"><label><h3><strong>用户信息数据导入</a></strong></h3></label></td> 
                </tr> 
                <tr> 
