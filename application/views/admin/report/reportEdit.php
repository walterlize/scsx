<div style="margin-left:20px; margin-right:20px">
    ...
    <form name="form1" method="post" action="<?=base_url()?>index.php/admin/report/save" id="form1">
        ...
        <table cellpadding="0" cellspacing="1" class="tablist2">
	        ...
	        <tr>
	            <td class="td1" style="width: 111px" >审核意见</td>
	            <td class="td2" >
	            <textarea rows="5" cols="100" name="repo_audit2_content"><?=$repo->repo_audit2_content?></textarea>
	            </td>
	        </tr>
            ...
            <tr>
                <td colspan="2" class="td3" align="center">
                    ...
                    <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?= base_url() ?>index.php/admin/report/reportList';" id="btnReturn" class="input" />
                    <input type="button" name="btnCancel" value="取 消" onclick="window.location.href='<?= base_url() ?>index.php/admin/report/reportDetail/<?= $repo->repo_id ?>';" id="btnCancel" class="input" style="<?php if (isset($show)) echo $show; ?>" />      </td>
            </tr>
        </table>
    </form>
</div>