...
<div class="enterright" style="background-color: #F8F8F8">
        ...
        <div class="enterrightlist" style="margin-top: 10px;">
        	...
        	<table width="100%" cellpadding="0" cellspacing="0">
                ...
                <input type="button" name="btnDelete" value="新 增" onclick="window.location.href='<?= base_url() ?>index.php/admin/imgnews/imgNew';" id="btnDelete" class="input" />
                <input type="button" name="btnReturn" value="删 除" onclick="window.location.href='<?= base_url() ?>index.php/admin/imgnews/imgList';" id="btnReturn" class="input"  style="display:none"/>
            </td>
            </tr>
