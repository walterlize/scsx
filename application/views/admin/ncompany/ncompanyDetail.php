        	...
        	<table width="99%" cellpadding="0" cellspacing="0">
		        ...
		        <tr>
		            <td colspan="2" class="td3" style="text-align: center;">
		                <input type="button" name="btnSave" value="编 辑" onclick="window.location.href='<?= base_url() ?>index.php/admin/ncompany/ncompanyEdit/<?= $company->comId?>';" id="btnSave" class="input" />
		                ...
		                <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?= base_url() ?>index.php/admin/ncompany/ncompanyList';" id="btnReturn" class="input" />      </td>
		        </tr>
            </table>
        </div>     
</div>
