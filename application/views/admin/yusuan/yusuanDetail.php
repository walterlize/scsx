    ...
    <h3 class="lz_title">实习预算明细</h3>
        ...
        <table cellpadding="0" cellspacing="1" class="tablist2"> 
            ...
            <tr>
             ...
             ?>
             <tr>
                <td class="td1" style="width: 111px;text-align: right;" colspan=6>合计：<?=$ss?>元</td>
            </tr>
            <tr>
                <td class="td1" style="width: 111px;text-align: right;" colspan=6>总计：<?=$ss+$ss1?>元</td>
            </tr>
            </table>
           ...
           <div style="text-align: center;">
            <br>
            		<input type="button" name="btnReturn" value="审 核" onclick="window.location.href='<?= base_url() ?>index.php/admin/yusuan/yusuanEdit/<?= $yusuan->ys_id ?>';" id="btnReturn" class="input" />
                    <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?= base_url() ?>index.php/admin/yusuan/yusuanList';" id="btnReturn" class="input" />
                    <input type="button" name="btnCancel" value="取 消" onclick="window.location.href='<?= base_url() ?>index.php/admin/yusuan/yusuanDetail/<?= $yusuan->ys_id ?>';" id="btnCancel" class="input" style="<?php if (isset($show)) echo $show; ?>" />      </td>
            </div>
