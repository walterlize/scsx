        ...
        <div class="menu">
            <ul id="nav">
                <li><a href="#"><span>报名管理</span></a>
                    <ul>
                        <li><a href="<?= base_url(); ?>index.php/student/program/programDetail" target="mainFrame"><span>查看实习项目</span></a></li>
                        <li><a href="<?= base_url(); ?>index.php/student/company/companyDetail" target="mainFrame"><span>提交基地信息</span></a></li>
                        <li><a href="<?= base_url(); ?>index.php/student/freestudent/freestudentDetail" target="mainFrame"><span>查看报名结果</span></a></li>
                    </ul></li>
            ...
            <div class="enterleft">
                ...
                <div id="firstpane" class="menu_list">
                    ...
                    <div style="display:block" class=menu_body >                
                        <a href="<?= base_url(); ?>index.php/student/program/programDetail" target="content1">查看实习项目</a>
                        <a href="<?= base_url(); ?>index.php/student/company/companyDetail" target="content1">提交基地信息</a>
                        <a href="<?= base_url(); ?>index.php/student/freestudent/freestudentDetail" target="content1">查看报名结果</a>                   
                    </div>
