<div style="margin-left:20px; margin-right:20px;">
    ...
    <table cellpadding="0" cellspacing="1" class="tablist2">
        ...
        <tr>
            ...
            <?php if($repo->repo_state == 1){?>
            	<input type="button" name="btnEdit" value="提 交" onclick="window.location.href='<?= base_url() ?>index.php/student/report/reportUpdate/<?= $repo->repo_id ?>';" id="btnEdit" class="input" />
                <input type="button" name="btnEdit" value="编 辑" onclick="window.location.href='<?= base_url() ?>index.php/student/report/reportEdit/<?= $repo->repo_id ?>';" id="btnEdit" class="input" />
                <input type="button" name="btnDelete" value="删 除" onclick="deleteInfo('<?= base_url() ?>index.php/student/report/reportDelete/<?= $repo->repo_id ?>')" id="btnDelete" class="input" />
            <?php }?>
