<!-----导航内容----->
		    <nav id="nav">
		    	<ul class="navbox">
		            ...
		            <li><a <?php if($title == "通知公告") echo 'class="navcurrent"';?> href="<?= base_url() ?>index.php/front/news/noticeList">通知公告</a></li>
		            <li><a <?php if($title == "实习规定") echo 'class="navcurrent"';?> href="<?= base_url() ?>index.php/front/news/ruleList">实习规定</a></li>
        ...
        <div class="newsrightbox">
            ...
            <div class="practicenewslist">
                ...
                <?php if (is_array($news)) foreach ($news as $r): ?>
                    <li>
                        <span><img src="<?= base_url() ?>images/newspage7.png"/></span><span class="date"><?=date("Y-m-d",strtotime($r['news_time']))?></span>
