<div style="margin-left:20px; margin-right:20px;">
    <br />
    <h1><font size=4><center>待回帖信息</center></font></h1>
    <center>
    <table cellpadding="0" cellspacing="1"  border="2" border-color="black" width="400" >
        ...
        <tr>
            <td colspan="2" class="td3" align="center">
                <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?= base_url() ?>index.php/luntan/luntan/luntan1List';" id="btnReturn" class="input" />      
            </td>
        </tr>
    </table></center>
</div>