<div style="margin-left:20px; margin-right:20px">
    <br />
    <h3>评价实习结果</h3>
    <form name="form1" method="post" action="<?= base_url() ?>index.php/master/mscore/save/<?= $mscore->stuId ?>" id="form1">
        <input type="hidden" value="<?= $mscore->s_id ?>" name="s_id" id="s_id" />
        <input type="hidden" value="<?= $mscore->stuId ?>" name="stuId" id="stuId" />
           ...
           <tr>
            ...
            <tr>
                <td colspan="2" class="td3" align="center">
                    ...
                    <input type="button" name="btnCancel" value="取 消" onclick="window.location.href='<?= base_url() ?>index.php/master/mscore/mscoreDetails/<?= $mscore->s_id ?>';" id="btnCancel" class="input" style="<?php if (isset($show)) echo $show; ?>" />      </td>
            </tr>
        </table>
    </form>
</div>