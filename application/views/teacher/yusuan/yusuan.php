    ...
    <table class="tablist" cellpadding="0" cellspacing="1" style="width:100%;border-collapse:collapse;" border="1">
        ...
        <?php if (is_array($yusuan)) foreach ($yusuan as $key=>$r): ?>
            	...
            	?>
                    ...
                    <td class="td1">
                        <a id="" href="<?= base_url() ?>index.php/teacher/yusuan/yusuanDetail/<?= $r['ys_id'] ?>">详细</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <tr>
            <td colspan="8" align="center" class="td3">
                <input type="button" name="btnDelete" value="新 增" onclick="window.location.href='<?= base_url() ?>index.php/teacher/yusuan/yusuanNew';" id="btnDelete" class="input" />
                <input type="button" name="btnReturn" value="删 除" onclick="window.location.href='<?= base_url() ?>index.php/teacher/yusuan/yusuanList';" id="btnReturn" class="input"  style="display:none"/>
            </td>
        </tr>
    </table>
