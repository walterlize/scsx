    ...
    <h3 class="lz_title">实习预算明细</h3>
        ...
        <table cellpadding="0" cellspacing="1" class="tablist2"> 
           ...
           <div style="text-align: center;">
            <br>
            <input type="button" name="btnReturn" value="上一步" onclick="window.location.href='<?= base_url() ?>index.php/teacher/yusuan/step3/<?= $yusuan->ys_id ?>';" id="btnReturn" class="input" <?php if($yusuan->ys_state != 0 )echo 'style="display:none;"'; ?>/>
