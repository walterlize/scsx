                ...
                <tr class="RowStyle" align="center">
                    ...
                    <td>
                    	<?php 
                    		if($r['coco']==1){
                    	?>
                    	<input type="button" name="btnReturn" value="取消设置" onclick="window.location.href='<?= base_url() ?>index.php/teacher/company/companyCancel/<?=$cour_id?>/<?=$r['coco_id']?>/<?=$r['comp_id']?>';" id="btnReturn" class="input" style="background-image: url('<?=base_url()?>/images/btnbg1.gif')"/>
                    	<?php 
                    		}else{
                    	?>
                    	<input type="button" name="btnReturn" value="设置基地" onclick="window.location.href='<?= base_url() ?>index.php/teacher/company/companySet/<?=$cour_id?>/<?=$r['comp_id']?>';" id="btnReturn" class="input" />
                    	<?php 
                    		}
                    	?>
