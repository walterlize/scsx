<div style="margin-left:20px; margin-right:20px">
    ...
    <table class="tablist2" cellpadding="0" cellspacing="1" style="width:100%;border-collapse:collapse;" border="1">
        <tr class="HeaderStyle">
            ...
            <th class="td3" scope="col">基地负责人</th>
            <th class="td1" scope="col">负责人联系方式</th>
            <th class="td3" scope="col">本课程基地</th>
            <th class="td1" scope="col">详情</th>
            <th class="td3" scope="col">操作</th>
        </tr>
        ...
        <tr>
            <td colspan="7" class="td3" align="center">
                ...
                if($flag>0){
                    ?>
                    <input type="button" name="btnReturn" value="发布课程" onclick="window.location.href='<?= base_url() ?>index.php/teacher/course/coursePublish1/<?=$o_id?>/<?=$cour_id?>';" id="btnReturn" class="input" />
                    <?php
                }else{
                    ?>
