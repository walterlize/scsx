    ...
    <table cellpadding="0" cellspacing="1" class="tablist2">
        ...
        <tr>
            <td colspan="2" class="td3" align="center">
                <input type="button" name="btnReturn" value="评 价" onclick="window.location.href='<?= base_url() ?>index.php/teacher/score/scoreNew2/<?= $stuId ?>/<?= $fb_id ?>';" id="btnReturn" class="input" />
