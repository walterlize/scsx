<div style="margin-left:20px; margin-right:20px">
    <br />
    <h3>评价实习结果</h3>
    <form name="form1" method="post" action="<?= base_url() ?>index.php/teacher/score/save/<?= $baoming->stuId ?>/1/<?= $baoming->fb_id ?>" id="form1">
        <input type="hidden" value="<?= $score->s_id ?>" name="s_id" id="s_id" />

        <table cellpadding="0" cellspacing="1" class="tablist2">  
            <tr>
                <td class="td1" style="width: 111px">实习项目名称</td>
                <td class="td2" ><?= $baoming->p_name ?>&nbsp;</td>
            </tr>  
            <tr>
                <td class="td1" style="width: 111px">学生姓名</td>
                <td class="td2" ><?= $baoming->sturealname ?>&nbsp;</td>
            </tr>      
            <tr>
                <td class="td1" style="width: 111px">学生院系</td>
                <td class="td2" ><?= $baoming->depart ?>&nbsp;</td>
            </tr>
            <tr>
