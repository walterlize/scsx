<div style="margin-left:20px; margin-right:20px;width:900px;">
    <br />
    <h3>实习基地信息编辑</h3>
    <form name="form1" method="post" action="<?= base_url() ?>index.php/teacher/compcourpublish/save/<?=$coursep->cour_id?>/<?=$o_id?>" id="form1">
        ...
        <table cellpadding="0" cellspacing="1" class="tablist2">
            ...
            <tr>
                <td colspan="2" class="td3" align="center">
                    ...
                    <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?= base_url() ?>index.php/teacher/compcourpublish/companyList/<?=$coursep->cour_id?>/<?=$o_id?>';" id="btnReturn" class="input" />
                </td>
            </tr>
        </table>
    </form>
