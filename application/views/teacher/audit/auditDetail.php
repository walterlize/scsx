    ...
    <table cellpadding="0" cellspacing="1" class="tablist2">
        ...
        <tr>
            <td colspan="2" class="td3" align="center">
            	<input type="button" name="btnReturn" value="审核通过" onclick="window.location.href='<?= base_url() ?>index.php/teacher/audit/auditPass/<?= $cour_id ?>/<?= $elco->elco_id?>';" id="btnReturn" class="input" /> 
            	<input type="button" name="btnReturn" value="审核失败" onclick="window.location.href='<?= base_url() ?>index.php/teacher/audit/auditFail/<?= $cour_id ?>/<?= $elco->elco_id?>';" id="btnReturn" class="input" /> 
