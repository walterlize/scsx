    ...
    <table cellpadding="0" cellspacing="1" class="tablist2">
        ...
        <tr>
            <td colspan="2" class="td3" align="center">
                <input type="button" name="btnReturn" value="编 辑" onclick="window.location.href='<?= base_url() ?>index.php/teacher/scoreappr/scoreEdit/<?= $score->scor_stu_num ?>/<?= $score->scor_cour_id ?>/<?= $score->scor_id ?>';" id="btnReturn" class="input" />
