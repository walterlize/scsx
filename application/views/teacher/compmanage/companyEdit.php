<div style="margin-left:20px; margin-right:20px;width:900px;">
    ...
    <form name="form1" method="post" action="<?= base_url() ?>index.php/teacher/compmanage/save" id="form1">
        ...
        <table cellpadding="0" cellspacing="1" class="tablist2">
            ...
            <tr>
                <td colspan="2" class="td3" align="center">
                    ...
                    <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?= base_url() ?>index.php/teacher/compmanage/companyDetail/<?=$comp->comp_id?>';" id="btnReturn" class="input" />
                </td>
            </tr>
        </table>
    </form>
