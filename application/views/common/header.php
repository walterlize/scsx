...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <link href="<?=base_url();?>css/css1.css" rel="stylesheet" type="text/css" />
...
function changeFrame(){
		...
		if(obj.cols!="10,*"){
			...
			document.getElementById("sidebar").innerHTML="<a href='#' onClick='changeFrame()'><img src='<?=base_url();?>images1/admin/menu_expand.gif' border='0'></a>";
		}else{
			obj.cols="208,*";
			document.getElementById("left_wrap").style.display="";
			document.getElementById("sidebar").innerHTML="<a href='#' onClick='changeFrame()'><img src='<?=base_url();?>images1/admin/menu_hide.gif' border='0'></a>";
		}
};
</script>
