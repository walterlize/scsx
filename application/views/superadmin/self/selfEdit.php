...
<div class="enterright" style="background-color: #F8F8F8">
        ...
        <form name="form1" method="post" action="<?= base_url() ?>index.php/superadmin/aself/selfSet" id="form1">
        <input type="hidden" value="<?= $admin->admin_id ?>" name="admin_id" id="admin_id" />
        	...
        	<tr>
                ...
                <td class="tablecontent" style="padding-left: 15px" ><?= $admin->admin_num ?>
            ...
            <tr>
                ...
                <select name="admin_roleId" style="display: none">
            ...
            <tr>
                ...
                <td class="tablecontent" style="padding-left: 15px" >无
                    <input type="hidden" name="admin_coll_name" value="<?=$admin->admin_coll_name?>" />          
                    </td>
            </tr>
            ...
            <tr>
                ...
                <td class="tablecontent" style="padding-left: 15px" >正常
                    
                <select name="admin_stat_id" style="display: none">
            ...
            <tr>
                <td colspan="2" class="td3" align="center" style="text-align: center;">
                    ...
                    <input type="button" name="btnCancel" value="取 消" onclick="window.location.href='<?= base_url() ?>index.php/superadmin/aself/selfDetail';" id="btnCancel" class="input" style="<?php if (isset($show)) echo $show; ?>" />      </td>
            </tr>
            </table>
        </form>
        </div>     
