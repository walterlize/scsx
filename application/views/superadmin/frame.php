                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td width="245" height="575" align="center" valign="top">
                                        <iframe name="content" scrolling="no" noresize src="<?= base_url(); ?>index.php/superadmin/frame/menu" height="100%" width="245" frameborder="0">                                
                                        </iframe>
                                    </td>
                                    <td width="849" valign="top" height="575">
                                        ...
                                        <iframe name="content1" noresize src="<?= base_url(); ?>index.php/superadmin/frame/main" height="100%" width="100%" frameborder="0">                
                                        </iframe>
                                    </td>
                                </tr>
                                <tr>
