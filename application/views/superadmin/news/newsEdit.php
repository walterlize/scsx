...
<div class="enterright" style="background-color: #F8F8F8">
        ...
        <form name="form1" method="post" action="<?= base_url() ?>index.php/superadmin/news/save" id="form1">
        ...
        <input type="hidden" value="<?= $news->news_count?>" name="news_count" id="news_count" />
            ...
            <tr>
                <td colspan="2" class="td3" align="center" style="text-align: center;">
                    ...
                    <input type="button" name="btnCancel" value="取 消" onclick="window.location.href='<?= base_url() ?>index.php/superadmin/news/newsDetail/<?= $news->news_id ?>';" id="btnCancel" class="input" style="<?php if (isset($show)) echo $show; ?>" />      </td>
            </tr>
            </table>
        </form>
        </div>     
